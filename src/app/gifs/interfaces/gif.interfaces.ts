...
export class Convert {
  public static toSSearchResponse(json: string): SearchResponse {
      return cast(JSON.parse(json), r("SSearchResponse"));
  }

  public static sSearchResponseToJson(value: SearchResponse): string {
      return JSON.stringify(uncast(value, r("SSearchResponse")), null, 2);
  }
}
